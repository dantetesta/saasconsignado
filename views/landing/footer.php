    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="/register" class="hover:text-white transition">Começar Grátis</a></li>
                </ul>
            </div>
        ...
        <div class="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6 text-sm">
                ...
                <a href="#" class="text-gray-500 hover:text-white transition">Política de Privacidade</a>
            </div>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-xs text-gray-600">
                Desenvolvido com ❤️ por <a href="https://dantetesta.com.br" target="_blank" class="text-blue-400 hover:text-blue-300 font-medium">Dante Testa</a>
            </p>
        </div>
    </div>
</footer>
