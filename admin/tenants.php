            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-lg w-full p-6">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div class="flex gap-3 pt-4">
                        ...
                        <button 
                            type="submit"
                            onclick="this.disabled=true; this.innerHTML='<svg class=\\'animate-spin w-5 h-5 mx-auto\\' fill=\\'none\\' stroke=\\'currentColor\\' viewBox=\\'0 0 24 24\\'><circle class=\\'opacity-25\\' cx=\\'12\\' cy=\\'12\\' r=\\'10\\' stroke-width=\\'4\\'></circle><path class=\\'opacity-75\\' d=\\'M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\\'></path></svg>'; this.form.submit();"
                            class="flex-1 px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-medium rounded-lg hover:from-cyan-700 hover:to-blue-700 transition disabled:opacity-50"
                        >
                            Enviar
                        </button>
                    </div>
