                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-8 py-5 text-center text-base text-blue-600">
                            <span class="bg-blue-100 px-3 py-1 rounded-full font-medium flex items-center justify-center gap-1">
                        ...
                        <td class="px-8 py-5 text-center text-base font-bold text-green-600">
                            <span class="bg-green-100 px-3 py-1 rounded-full flex items-center justify-center gap-1">
